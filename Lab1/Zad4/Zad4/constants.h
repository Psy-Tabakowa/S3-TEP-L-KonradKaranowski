...
// procedurest test
const std::string PROC_TAB_NAME = "Imie";
...
// test cloning 
const std::string DYN_JANUSZ_NAME = "Janusz";
const std::string DYN_ALBERT_NAME = "Albert";
const std::string DYN_ZBIGNIEW_NAME = "Zbiegniew";
